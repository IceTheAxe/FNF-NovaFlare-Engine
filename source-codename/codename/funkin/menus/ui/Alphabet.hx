package codename.funkin.menus.ui;

import flixel.util.typeLimit.OneOfTwo;
import haxe.ds.Vector;
import codename.funkin.menus.ui.effects.RegionEffect;
...
@:allow(codename.funkin.editors.alphabet.AlphabetEditor)
@:allow(codename.funkin.editors.alphabet.AlphabetMainDataScreen)
