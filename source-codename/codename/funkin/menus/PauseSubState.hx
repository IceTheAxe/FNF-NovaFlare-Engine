...
import codename.funkin.backend.scripting.events.menu.pause.*;
...
import codename.funkin.menus.StoryMenuState;
import codename.funkin.options.OptionsMenu;
import codename.funkin.options.keybinds.KeybindsOptions;
