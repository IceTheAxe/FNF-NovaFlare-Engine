...
import codename.funkin.backend.chart.ChartData.ChartMetaData;
import codename.funkin.backend.scripting.events.menu.MenuChangeEvent;
import codename.funkin.backend.scripting.events.menu.freeplay.*;
import codename.funkin.backend.system.Conductor;
import codename.funkin.game.HealthIcon;
...
class FreeplaySonglist {
	...
	public function getSongsFromSource(source:codename.funkin.backend.assets.AssetSource, useTxt:Bool = true) {
