package codename.funkin.backend.system.updating;

import flixel.addons.transition.FlxTransitionableState;
import flixel.math.FlxPoint;
import codename.funkin.backend.FunkinText;
import codename.funkin.backend.system.updating.UpdateUtil.UpdateCheckCallback;
import codename.funkin.backend.utils.MarkdownUtil;
import codename.funkin.menus.MainMenuState;
