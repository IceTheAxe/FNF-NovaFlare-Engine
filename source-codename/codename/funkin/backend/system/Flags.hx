...
import codename.funkin.backend.assets.ScriptedAssetLibrary;
import codename.funkin.backend.system.macros.GitCommitMacro;
import codename.funkin.backend.utils.IniUtil;
 ...
 */
@:build(codename.funkin.backend.system.macros.FlagMacro.build())
class Flags {
	...
	@:also(codename.funkin.game.Character.FALLBACK_CHARACTER)
	public static var DEFAULT_CHARACTER:String = "bf";
	public static var DEFAULT_GIRLFRIEND:String = "gf";
	public static var DEFAULT_OPPONENT:String = "dad";

	@:also(codename.funkin.game.PlayState.difficulty)
	...
	@:also(codename.funkin.game.PlayState.coopMode)
	public static var DEFAULT_COOP_MODE:Bool = false; // used in playstate if it doesn't find it
	@:also(codename.funkin.game.PlayState.opponentMode)
	...
	@:also(codename.funkin.game.Character.FALLBACK_DEAD_CHARACTER)
	...
	@:also(codename.funkin.game.PlayState.daPixelZoom)
	...
	@:also(codename.funkin.backend.MusicBeatTransition.script)
	public static var DEFAULT_TRANSITION_SCRIPT:String = "";
	@:also(codename.funkin.menus.PauseSubState.script)
	public static var DEFAULT_PAUSE_SCRIPT:String = "";
	@:also(codename.funkin.game.GameOverSubstate.script)
	...
	@:also(codename.funkin.backend.utils.HttpUtil.userAgent)
	...
	**/
	public static function load(?libs:Array<LimeAssetLibrary> = null) {
		...
		for(lib in libs) {
			...
			if(lib is codename.funkin.backend.assets.TranslatedAssetLibrary) {
