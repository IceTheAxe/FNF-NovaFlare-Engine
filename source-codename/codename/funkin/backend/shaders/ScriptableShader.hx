package codename.funkin.backend.shaders;

import hscript.IHScriptCustomBehaviour;
import codename.funkin.backend.scripting.events.shader.ShaderProcessEvent;
...
@:access(codename.funkin.backend.shaders.FunkinShader)
