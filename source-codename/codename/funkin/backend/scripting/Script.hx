package codename.funkin.backend.scripting;
...
@:allow(codename.funkin.backend.scripting.ScriptPack)
/**
...
class Script extends FlxBasic implements IFlxDestroyable {
	...
	public static function getDefaultVariables(?script:Script):Map<String, Dynamic> {
		return [
			...
			"ModState"			=> codename.funkin.backend.scripting.ModState,
			"ModSubState"		=> codename.funkin.backend.scripting.ModSubState,
			"PlayState"			=> codename.funkin.game.PlayState,
			"GameOverSubstate"	=> codename.funkin.game.GameOverSubstate,
			"HealthIcon"		=> codename.funkin.game.HealthIcon,
			"HudCamera"			=> codename.funkin.game.HudCamera,
			"Note"				=> codename.funkin.game.Note,
			"Strum"				=> codename.funkin.game.Strum,
			"StrumLine"			=> codename.funkin.game.StrumLine,
			"Character"			=> codename.funkin.game.Character,
			"Boyfriend"			=> codename.funkin.game.Character, // for compatibility
			"PauseSubstate"		=> codename.funkin.menus.PauseSubState,
			"FreeplayState"		=> codename.funkin.menus.FreeplayState,
			"MainMenuState"		=> codename.funkin.menus.MainMenuState,
			"PauseSubState"		=> codename.funkin.menus.PauseSubState,
			"StoryMenuState"	=> codename.funkin.menus.StoryMenuState,
			"TitleState"		=> codename.funkin.menus.TitleState,
			"Options"			=> codename.funkin.options.Options,
			"Paths"				=> codename.funkin.backend.assets.Paths,
			"Conductor"			=> codename.funkin.backend.system.Conductor,
			"FunkinShader"		=> codename.funkin.backend.shaders.FunkinShader,
			"CustomShader"		=> codename.funkin.backend.shaders.CustomShader,
			"FunkinText"		=> codename.funkin.backend.FunkinText,
			"FlxAnimate"		=> animate.FlxAnimate,
			"FunkinSprite"		=> codename.funkin.backend.FunkinSprite,
			"Alphabet"			=> codename.funkin.menus.ui.Alphabet,
			"Flags"				=> codename.funkin.backend.system.Flags,

			"CoolUtil"			=> codename.funkin.backend.utils.CoolUtil,
			"IniUtil"			=> codename.funkin.backend.utils.IniUtil,
			"XMLUtil"			=> codename.funkin.backend.utils.XMLUtil,
			#if sys "ZipUtil"	=> codename.funkin.backend.utils.ZipUtil, #end
			"MarkdownUtil"		=> codename.funkin.backend.utils.MarkdownUtil,
			"EngineUtil"		=> codename.funkin.backend.utils.EngineUtil,
			"ThreadUtil"		=> codename.funkin.backend.utils.ThreadUtil,
			"MemoryUtil"		=> codename.funkin.backend.utils.MemoryUtil,
			"BitmapUtil"		=> codename.funkin.backend.utils.BitmapUtil,

			#if TRANSLATIONS_SUPPORT
			"TranslationUtil"	=> codename.funkin.backend.utils.TranslationUtil,
			"translate"		=> codename.funkin.backend.utils.TranslationUtil.get,
			#end
		];
	}
	...
	**/
	public static function getDefaultImportRedirects():Map<String, String> {
		...
		// Events
		final events = "codename.funkin.backend.scripting.events.";
		...
		{
			if (entry.key.startsWith("codename.funkin."))
				redirects[entry.key.substr("codename.".length)] = entry.value;
		}
	...
	public static function getDefaultPreprocessors():Map<String, Dynamic> {
		var defines = codename.funkin.backend.system.macros.DefinesMacro.defines;
