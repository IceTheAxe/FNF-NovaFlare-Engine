...
import codename.funkin.backend.scripting.*; // lazy
import codename.funkin.backend.scripting.events.CancellableEvent;
import codename.funkin.backend.scripting.events.discord.DiscordPresenceUpdateEvent;
import codename.funkin.backend.system.macros.Utils;
import haxe.Json;
...
final class DiscordUtil
{
	...
	public static function changePresenceAdvanced(data:DPresence)
	{
		...
		codename.funkin.backend.scripting.GlobalScript.event("onDiscordPresenceUpdate", evt);
		#end
