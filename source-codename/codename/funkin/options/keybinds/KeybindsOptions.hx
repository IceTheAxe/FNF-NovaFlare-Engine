package codename.funkin.options.keybinds;
...
class KeybindsOptions extends MusicBeatSubstate {
	...
	public function loadCustomCategories() {
		...
		for(source in [codename.funkin.backend.assets.AssetSource.SOURCE, codename.funkin.backend.assets.AssetSource.MODS]) {
