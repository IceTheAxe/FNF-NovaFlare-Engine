...
**/
@:build(codename.funkin.backend.system.macros.OptionsMacro.build())
@:build(codename.funkin.backend.system.macros.FunkinSaveMacro.build("__save", "__flush", "__load"))
class Options
{
	@:dox(hide) @:doNotSave
	...
	public static var contributors:Array<codename.funkin.backend.system.github.GitHubContributor.CreditsGitHubContributor> = [];
