...
class EditorPicker extends MusicBeatSubstate {
	...
	public var options:Array<Editor> = [
		{
			name: "Chart Editor",
			id: "chart",
			state: codename.funkin.editors.charter.CharterSelection
		},
		{
			name: "Character Editor",
			id: "character",
			state: codename.funkin.editors.character.CharacterSelection
		},
		{
			name: "Stage Editor",
			id: "stage",
			state: codename.funkin.editors.stage.StageSelection
		},
		{
			name: "Alphabet Editor",
			id: "alphabet",
			state: codename.funkin.editors.alphabet.AlphabetSelection
		},
		#if (debug || debug_ui)
		{
			name: "UI Debug State",
	...
	public override function update(elapsed:Float) {
		...
		changeSelection(-scroll + (controls.UP_P ? -1 : 0) + (controls.DOWN_P ? 1 : 0));
