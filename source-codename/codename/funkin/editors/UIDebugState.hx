...
import codename.funkin.editors.ui.old.OldUISliceSpriteTri;
import codename.funkin.editors.ui.UITopMenu.UITopMenuButton;
import flixel.tweens.FlxTween;
import codename.funkin.editors.ui.*;
		...
		add(topMenuSpr = new UITopMenu([
			{
				...
				childs: [
					...
					{
						label: "Exit",
						onSelect: (t) -> {FlxG.switchState(new codename.funkin.menus.MainMenuState());}
					}
				]
			},
			{
