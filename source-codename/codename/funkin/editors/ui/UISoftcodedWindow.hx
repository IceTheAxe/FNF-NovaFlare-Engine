...
import codename.funkin.backend.scripting.HScript;
import codename.funkin.backend.scripting.Script;
import codename.funkin.editors.extra.PropertyButton;
import codename.funkin.editors.stage.elements.StageElementButton;
import codename.funkin.editors.ui.UIDropDown;
