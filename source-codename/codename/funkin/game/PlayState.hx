...
import codename.funkin.backend.chart.Chart;
import codename.funkin.backend.chart.ChartData;
import codename.funkin.backend.chart.EventsData;
...
import codename.funkin.backend.scripting.events.gameplay.*;
import codename.funkin.backend.scripting.events.note.*;
import codename.funkin.backend.system.Conductor;
import codename.funkin.backend.system.RotatingSpriteGroup;
import codename.funkin.editors.SaveWarning;
import codename.funkin.editors.charter.Charter;
import codename.funkin.editors.charter.CharterSelection;
import codename.funkin.game.SplashHandler;
import codename.funkin.game.cutscenes.*;
import codename.funkin.game.scoring.*;
import codename.funkin.game.scoring.RatingManager.Rating;
import codename.funkin.menus.*;
...
@:access(codename.funkin.game.StrumLine)
	...
	**/
	...
	override public function update(elapsed:Float)
	{
		...
		if (canAccessDebugMenus && chartingMode && controls.DEV_ACCESS)
			FlxG.switchState(new codename.funkin.editors.charter.Charter(SONG.meta.name, difficulty, variation, false));
